...
- [Ecosystem design](https://epiaware.org/approaches/) — why composition, what
  is wanted from it, and the approaches being explored.
...
- [{{PACKAGE}} documentation](https://{{DOCS_URL}})
